...
class ControladorJogo(AbstractControladorJogo):
    ...
    def inclui_personagem_na_lista(self,
        ...
        self.__personagems.append(personagem_novo)
    ...
    def iniciaJogo(self, jogador1: Jogador, jogador2: Jogador):
        jogador1.mao.append(self.__baralho[:5])
        del self.__baralho[:5]
        jogador2.mao.append(self.__baralho[:5])
        del self.__baralho[:5]
    ...
    def jogada(self, mesa: Mesa) -> Jogador:
        ...
        carta_jogador_1 = mesa.carta_jogador1
        valor_total_1 = carta_jogador_1.valor_total_carta()
        jogador2 = mesa.jogador2
        carta_jogador_2 = mesa.carta_jogador2
        valor_total_2 = carta_jogador_2.valor_total_carta()
        if valor_total_1 > valor_total_2:
            jogador1.inclui_carta_na_mao(carta_jogador_1)
            jogador1.inclui_carta_na_mao(carta_jogador_2)
            return jogador1
        elif valor_total_2 > valor_total_1:
            jogador2.inclui_carta_na_mao(carta_jogador_1)
            jogador2.inclui_carta_na_mao(carta_jogador_2)
            return jogador2
        elif valor_total_1 == valor_total_2:
            jogador1.inclui_carta_na_mao(carta_jogador_1)
            jogador2.inclui_carta_na_mao(carta_jogador_2)
            return None
